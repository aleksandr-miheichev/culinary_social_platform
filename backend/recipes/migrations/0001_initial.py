    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(error_messages={'Ошибка': 'Пожалуйста, установите время приготовления данного рецепта более 1 минуты'}, help_text='Укажите время приготовления в минутах для данного блюда', validators=[django.core.validators.MinValueValidator(1)], verbose_name='Время приготовления в минутах')),
            ],
            options={
                'verbose_name': 'Рецепт',
