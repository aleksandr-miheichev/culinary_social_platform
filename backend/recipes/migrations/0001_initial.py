    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FF0000', help_text='Введите цвет в формате hex для тега', image_field=None, max_length=7, samples=None, unique=True, verbose_name='Цвет в формате hex')),
